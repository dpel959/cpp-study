...
public:
	...
	// 아니, 대체 왜요? -> 가장 핵심 : 컨테이너::iterator 이 형태를 유지해야 template로 돌려 쓸 거 아니야. auto는 문제 없겠다만
	// 그리고 만약 클래스 이름을 바꿔도 은닉화해서 사용자가 코드를 안 바꿔도 되니까 + 컨테이너 이름이 iterator이름에 붙어 널려있는 것보다 깔금 뭐 이건 부수적인 것
